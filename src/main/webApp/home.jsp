...
<div id="img1"><a href="https://geu.ac.in/"><img alt="Loading..." src="Graphic-Era-Hill-University.png"></a></div>
<div id="img2"><a href="https://teresaschoolkgm.org/"><img alt="Loading..." src="st.png"></a></div>
<h3>S.Theresa SR. SEC. SCHOOL</h3>
<span class="education-date">Jan 01, 2019 - Dec 27, 2020 </span>
<h4>PCM with C.S  (Marks-80%)</h4>

<h3>Graphic Era Deemed To Be University</h3>
<span class="education-date">August 06, 2021 - May 27, 2025 </span>
<h4>Bachelor of Technology in Computer Science  (GPA-8.37)</h4>
</div>


<div id="experience" class="background-alt">
<h2 class="heading">Experience</h2>
<h3>PhysicsWallah PVT. LTD.</h3>
<span class="education-date">july 02, 2024 - Aug 10, 2024</span>
<h4>Software Developer</h4>
<ul>
  <li>Developed a comprehensive image-to-text converter website using Django, which included features for uploading images, extracting text through Optical Character Recognition (OCR), and providing options to download the extracted text in various formats such as PDF, DOCX, and TXT.</li>
  <li>Designed and implemented a mobile application using BeeWare that integrates with the Django backend to allow users to convert images to text on their mobile devices, providing a seamless experience across web and mobile platforms.</li>
  <li>Enhanced the website's user interface and experience by incorporating responsive design principles and ensuring compatibility across different devices and browsers, thus improving accessibility and usability for a diverse user base.</li>
  <li>Conducted thorough testing and debugging to ensure the reliability and accuracy of text extraction, addressing issues related to image quality and text recognition to achieve high performance and user satisfaction.</li>  
</ul>
</div>
...
<div id="contact">
<h2>Get in Touch</h2>
<a href="https://github.com/bhumikap1" target="_blank">GitHub</a>
<a href="https://www.linkedin.com/in/bhumika-pawar-286024250/" target="_blank">LinkedIn</a>
<a href="https://leetcode.com/u/Bhumika2/" target="_blank">LeetCode</a>
</div>
